      ...
      <div className="max-w-md w-full space-y-8 bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 p-8 rounded-2xl shadow-xl">
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-zinc-500 dark:text-zinc-400">
            ...
            <Link href="/login" className="font-semibold text-green-600 hover:text-green-500 dark:text-green-500">
              Sign in
            </Link>
          </p>
        </div>
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          <div className="space-y-4">
            <div>
              <label htmlFor="fullName" className="block text-sm font-semibold text-zinc-700 dark:text-zinc-300 mb-1">
                Full Name
              </label>
              <Input
                id="fullName"
