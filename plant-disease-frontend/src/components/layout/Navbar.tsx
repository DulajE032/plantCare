...
import { Sprout, Home, ScanLine, BookOpen, Clock, FileText, User } from "lucide-react"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-1">
          ...
          <Link
            ...
            className={`px-4 py-2 rounded-lg text-sm font-semibold transition-colors ml-2 border border-zinc-200 dark:border-zinc-850 flex items-center gap-1.5 ${
              pathname === "/profile" || pathname === "/login"
                ? "bg-green-550 text-white border-green-600 hover:bg-green-650"
                : "text-zinc-700 hover:text-zinc-950 bg-zinc-50 dark:text-zinc-300 dark:bg-zinc-900 dark:hover:bg-zinc-850"
            }`}
          >
